...
class Fieldset extends Child implements \ArrayAccess, \Countable, \IteratorAggregate {
	 ...
	 *
	 * @param  array  $fields fields collection.
	 * @param  string $container container element tag.
	 */
	 ...
	 *
	 * @param  string $container element tag.
	 * @return Fieldset
	 */
	 ...
	 *
	 * @param  Element\AbstractElement $field field to add.
	 * @return Fieldset
	 */
	 ...
	 *
	 * @param  string                  $name the name of the field where we're going to prepend the field.
	 ...
	 *
	 * @param  string                  $name the name of the field where we're going to append the new field.
	 * @param  Element\AbstractElement $field the field to add.
	 * @return Fieldset
	 */
	 ...
	 *
	 * @param  string $legend title of the legend.
	 * @return Fieldset
	 */
	 ...
	 *
	 * @param  string $name property to verify.
	 * @return boolean
	 */
	 ...
	 *
	 * @param  mixed $offset offset number.
	 * @return boolean
	 */
